				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Layout 1','footer_layout1',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Layout 2','footer_layout2',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-md-12 col-sm-12"> 
							<?php echo create_position('Footer Layout 3','footer_layout3',$layout_modules,$extensions,$module_row); ?>
						</div>
					 </div>
				</div>
          </fieldset>
