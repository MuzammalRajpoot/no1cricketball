	...
	<div class="product-layout <?php echo $device_res;?>">
		<div class="product-item-container">
			<div class="left-block">
				<?php //if($product['subtract_status'] && isset($product['subtract_status'])):?>
					<div class="label-stock label label-success <?php echo $product['stock_status'] ;?>"><?php echo $product['stock_status'] ;?></div> 
				<?php //endif;?>
				...
				<div class="button-group">
					<!-- CART -->
					<button class="addToCart btn-button" type="button" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');">
