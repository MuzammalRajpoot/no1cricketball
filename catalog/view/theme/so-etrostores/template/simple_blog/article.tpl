                        	...
                        	<div class="blog-item-inner">
								...
								<div class="itemBlogContent right-block">
									...
									<div class="blog-content">
										...
										<!-- COMMENT -->
								  		<div class="blog-meta">
								  			<span class="author"><i class="fa fa-tags"></i><?php echo $article['author_name']; ?></span>
										...
										<a class="btn-viewmore font-title" href="<?php echo $article['href']; ?>"><i class="fa fa-caret-right"></i><?php echo $button_continue_reading; ?></a>
									</div>		
