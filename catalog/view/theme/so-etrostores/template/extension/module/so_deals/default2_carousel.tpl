					...
					<div class="row">
							...
							<div class="image">
								...
								<?php if($product_image) { ?>
								 ...
								 <div class="button-group so-quickview">
									<?php if($display_addtocart)
									{?>
										<button class="btn-button addToCart" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_cart'); ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i></button>
									<?php
									}?>	
									<?php if($display_wishlist)
									{?>
										<button class="btn-button wishlist" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_wishlist'); ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart-o"></i></button>
									<?php
									}?>
									<?php if($display_compare)
									{?>
										<button class="btn-button compare" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-retweet"></i></button>
									<?php }?>
						...
						<div class="item-right col-lg-6 col-md-6">
							<div class="category-name">
								...
								<?php foreach ($product['category_info'] as $key => $value) {
									if (in_array($value['category_id'], $category)) echo '<a href="'.$our_url->link('product/category','path='.$value['category_id']).'">'.$value['name'].'</a>';
							...
							<div class="caption">
								...
								<!-- <a class="reviews_button" href=""><?php echo $reviews; ?></a> -->
								<?php endif;?>
