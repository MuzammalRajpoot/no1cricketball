<div id="<?php echo $tag_id?>" class="so-deal clearfix <?php echo $class_respl; ?> <?php if($button_page == "top"){echo "button-type1";}else{echo "button-type2";} ?> style2">
				...
				<div class="image">
					...
					<?php if($display_addtocart || $display_wishlist || $display_compare){	?>
						...
						<?php if($display_addtocart){?>
							<button class="addToCart btn-button" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $objlang->get('button_cart'); ?></span></button>
						<?php	}?>
	...
	<?php }?>
	<div class="products-list grid extraslider-inner" data-effect="<?php echo $effect; ?>">
