...
<div id="so-groups" class="<?php echo $position?> so-groups-sticky hidden-xs" style="top: <?php echo $top.'px';?>">
	...
	<a class="sticky-mycart" data-target="popup" data-popup="#popup-mycart"><i class="fa fa-shopping-cart"></i></a>
	<?php }?>
	<?php if ($settings['show_account']) {?>
	<a class="sticky-myaccount" data-target="popup" data-popup="#popup-myaccount"><i class="fa fa-user"></i></a>
	<?php }?>
	<?php if ($settings['show_search']) {?>
	<a class="sticky-mysearch" data-target="popup" data-popup="#popup-mysearch"><i class="fa fa-search"></i></a>
	<?php }?>
	<?php if ($settings['show_recent_product']) {?>
	<a class="sticky-recent" data-target="popup" data-popup="#popup-recent"><i class="fa fa-recent"></i></a>
	<?php }?>
			...
			<div class="popup-position">
				<div class="popup-container popup-small">
					<div class="popup-header">
						...
						<a class="popup-close" data-target="popup-close" data-popup-close="#popup-categories"><i class="fa fa-times"></i></a>
					</div>
				...
				<div class="popup-container popup-small">
					<div class="popup-html">
						<div class="popup-header">
							...
							<a class="popup-close" data-target="popup-close" data-popup-close="#popup-myaccount"><i class="fa fa-times"></i></a>
						</div>
						<div class="popup-content">
				...
				<div class="popup-container popup-small">
					<div class="popup-html">
						<div class="popup-header">
							...
							<a class="popup-close" data-target="popup-close" data-popup-close="#popup-mysearch"><i class="fa fa-times"></i></a>
						</div>
						<div class="popup-content">
							<div class="form-content">
								<div class="row space">
									...
									<div class="col">
										<div class="form-box">
											<button type="button" id="button-search" class="btn"><?php echo $text_search?></button>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="popup-container popup-small">
					<div class="popup-html">
						<div class="popup-header">
							...
							<a class="popup-close" data-target="popup-close" data-popup-close="#popup-recent"><i class="fa fa-times"></i></a>
						</div>
						<div class="popup-content">
							<div class="form-content">
								<div class="row space">
