<?php
// Heading 
$_['heading_title']					= 'المشاركات';

// Buttons
$_['button_continue_reading']		= 'اقرأ أكثر';
$_['button_submit']					= 'اترك تعليقا';
...
$_['entry_review']					= 'تعليق';

// Text
$_['text_no_found']					= 'لا يوجد تعليقات على الكاتالوج!';
$_['text_related_product']			= 'Related Products';
$_['text_related_comment']			= 'تعليقات';
$_['text_related_article']			= 'Blog Related Article';
$_['text_author_information']		= '(Author)';
$_['text_posted_by']				= 'أرسلت بواسطة';
$_['text_on']						= 'On';
...
$_['text_write_comment']			= 'ترك تعليقك';
$_['text_note']						= 'ملاحظة: لم يتم تفعيل اكواد HTML!';
$_['text_comments']					= ' تعليقات';
$_['text_comment']					= ' تعليق';
$_['text_no_blog']   				= 'لا توجد تعليقات لهذا بلوق.';
$_['text_on']           			= ' on ';
